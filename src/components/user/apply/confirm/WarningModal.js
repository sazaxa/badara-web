...
const WaringModal = ({ visible, close, apply }) => {
    ...
    return (
        <Fullscreen>
            <AskModalBlock style={{ width: '50%' }}>
                <div className="header" style={{ marginBottom: '10px', padding: '5px 0' }}>
                    <strong style={{ fontSize: '26px', color: 'red', letterSpacing: '-2px' }}>신청 전 주의사항</strong>
                </div>
                ...
                <p style={{ letterSpacing: '-1.5px' }}>
                    ...
                    단, 상품 유실과 같은 배송사 귀책이 분명할 시 배송사의 보상한도 규정에 따라 보상 받을 수 있습니다.
                </p>
