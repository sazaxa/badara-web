...
import { TosBox, TosWrap } from 'styles/RegisterStyles';
import Button from '@material-ui/core/Button';

const Tos = ({ HandleAgree }) => {
    ...
    return (
        <TosWrap>
            ...
            <TosBox>
                ...
                발송의뢰인, (이하 ‘회원’이라 함), 각 배송사 DHL, EMS 등, (이하 ‘배송사’라 함) 회사와 회원의 권리와 의무
                ...
                <br />
                <br />
                a. 전자제품, 음식류 (밀폐포장), 파손되기 쉬운 물품은 발송은 가능하나, 분실 및 파손, 세관에 의한 폐기에
                대해서는 운송비를 포함해 일체보상을 받지 못합니다. 허나 일부가 아닌, 운송물 전체가 사라진 경우에는
                “배송사”의 보상한도 규정에 따라 보상 받을 수도 있습니다.
                <br />
                ...
                <br />
                c. “BADARA“가 정당한 권한이 있는 것으로 판단한 제3자의 요청이 있는 경우, 물품을 수하인의 수입 관세사나
                다른 주소지로 인계할 수 있습니다. 
                <br />
                <br />
                ...
                <br />
                c. 안전하게 또는 합법적으로 운송할 수 없다고  판단하는 물품 (그런 물품에는 동물류, 현금이나 유가증권,
                귀금속, 장물, 폭발물, 군수품, 군수부품, 포르노그라피, 불법약물이나 마약류 등이 포함되며 이에 한정되지
                않습니다.)(위에 열거한 취급불가 발송물품을 “BADARA”로 발송 할 경우 사전에 “BADARA”에게 어떠한 형태로든
                알려야합니다. 그렇지 않을 경우 그 물품으로 발생한 모든 불이익에 대해 “회원”이 책임을 집니다.)
                <br />
                <br />
                <strong> 제 4조, 배송 및 불가</strong>
                <br />
                <br />
                a. 발송물은 “회원”이 제공하는 수취인 주소지로 배달되게 되나 수취인이 반드시 개인이 될 필요는 없습니다.
                중앙수취지역으로 되어있는 발송물은 그 지역으로 배달됩니다.
                <br />
                ...
                “BADARA” 서비스를 이용하면서 발생한 운송료, 장치료, 관세, 세금, 기타비용을 의미합니다. 또한 상기 2항의
                취급불가 발송품의 발송으로 인한 클레임, 파손, 벌금, 비용 등도 지불해야 합니다.
                <br />
                <br />
                <strong>제 7조, 책임</strong>
                <br />
                <br />
                “BADARA”는 단순 발송물 수집 접수대행 업체입니다. 따라서 발송물의 위법여부에 대한 책임이나 지연 및 파손,
                분실에 의해 발생하는 직,간접적 손해에 대해서는 일체의 책임이 없습니다. 하지만, “BADARA”는 “회원”의
                입장에서 “배송사”와 모든 문제가 원만히 해결될 때까지 최대한의 노력을 할 것을 약속합니다.
                <br />
                <br />
                <strong>제 8조, 손해배상의 청구 기한</strong>
                <br />
                <br />
                “BADARA”가 물품을 수령한 30일 이내에 “회원”은 손해배상 청구를 서면으로 제출해야합니다. 그렇지 않은 경우
                “BADARA”는 책임을 지지 않습니다.
                <br />
                <br />
                <strong>제 9조, 보험</strong>
                <br />
                <br />
                보험을 요청, 관련 보험료를 지불하실 경우 화물의 손실이나 실물파손의 실재현금 가치에 대해 보험을 주선할
                수 있습니다. (단, 각 배송사별 보험적용불가품목, 음식물 등 제외)보험은 간접 손실 (기회 이익, 이자, 미래의
                사업 등) 이나 손해, 지연에 의해 야기된 손실이나 손해는 보장하지 않습니다.
                <br />
                <br />
                ...
                입출항 봉쇄, 폭동 또는 민간 소요사태- 물품자체의 특성으로 인한 부패 및 결함- 운송사이가 아닌 자에 의한
                작위 또는 부작위 (아래의 주체를 포함합니다) <br />
                ...
                <br />
                <br />
                약관기준에 대하여 발생되는 모든 분쟁은 예외 없이 선적국가의 비 배타적인 재판 관할에 귀속되며 그 국가의
                법이 준거법이 됩니다. “회원”은 적용되는 법률이 배치되지 않는 한 상기 재판의 관할에 따라야 합니다.
                <br />
                <br />
            ...
            <article className="agreeBox">
                <article className="inputBox">
                    <input type="checkbox" id="agree" onChange={e => handleOnChecked(e)} />
