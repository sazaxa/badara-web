export { default as AdminHeaderComponent } from './common/AdminHeaderComponent';
...
export { default as LoginPopupComponent } from './common/LoginPopupComponent';

export { default as FaqAddComponent } from './admin/faq/FaqAddComponent';
export { default as FaqComponent } from './admin/faq/FaqComponent';
...
export { default as SupportConponent } from './user/support/SupportConponent';
